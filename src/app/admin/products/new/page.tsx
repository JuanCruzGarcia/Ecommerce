                    ...
                    <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 sticky top-24">
                        ...
                        <div className="space-y-5">
                            ...
                            <div className="pt-2 border-t border-gray-100 mt-2">
                                ...
                                <div
                                    className={`flex items-center justify-between p-3 rounded-lg border ${isFeatured ? 'bg-yellow-50 border-yellow-200' : 'bg-gray-50 border-gray-200'} transition-all cursor-pointer`}
                                ...
                                >
                                    <div className="flex items-center gap-2">
                                        ...
                                        <span className={`text-sm font-semibold ${isFeatured ? 'text-yellow-900' : 'text-gray-900'}`}>{isFeatured ? 'Destacado' : 'No Destacado'}</span>
                                    </div>
                                    <div className={`w-8 h-5 flex items-center rounded-full p-0.5 transition-colors ${isFeatured ? 'bg-yellow-500' : 'bg-gray-300'}`}>
                                        <div className={`bg-white w-3.5 h-3.5 rounded-full shadow-sm transform transition-transform ${isFeatured ? 'translate-x-3.5' : 'translate-x-0'}`} />
                                    </div>
                                </div>
                            </div>
                        </div>
