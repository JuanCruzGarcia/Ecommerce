    ...
    return (
        <div className="bg-background-light dark:bg-background-dark min-h-screen flex items-center justify-center font-display">
            <div className="flex w-full min-h-screen overflow-hidden">
                ...
                <div className="w-full lg:w-1/2 flex flex-col justify-center items-center bg-white dark:bg-background-dark p-8 md:p-20">
                    <div className="max-w-[440px] w-full space-y-8">
                        <div className="text-left space-y-2">
                            <h2 className="text-4xl font-black text-slate-900 dark:text-slate-100 tracking-tight">Bienvenido de nuevo</h2>
                            <p className="text-slate-500 dark:text-slate-400 font-medium">Ingresa tus credenciales para acceder a tu cuenta</p>
                        </div>
                        ...
                        <form className="space-y-5" onSubmit={handleLogin}>
                            ...
                            <div className="space-y-2">
                                <label className="text-sm font-bold text-slate-700 dark:text-slate-300 ml-1" htmlFor="email">Correo electrónico</label>
                                <div className="relative group">
                                    ...
                                    <input 
                                        ...
                                        className="block w-full pl-11 pr-4 h-14 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all outline-none text-slate-900 dark:text-slate-100 placeholder:text-slate-400" 
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative group">
                                    ...
                                    <input 
                                        ...
                                        className="block w-full pl-11 pr-12 h-14 bg-slate-50 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 rounded-xl focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all outline-none text-slate-900 dark:text-slate-100 placeholder:text-slate-400" 
                                        placeholder="••••••••" 
                                    />
                            ...
                            <div className="flex items-center gap-2 py-1">
                                ...
                                <label className="text-sm font-medium text-slate-600 dark:text-slate-400" htmlFor="remember">Recordarme</label>
                            </div>
                        ...
                        <button 
                            ...
                            disabled={loading}
                            className="w-full h-14 flex items-center justify-center gap-3 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl hover:bg-slate-50 dark:hover:bg-slate-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                        >
                            ...
                            <span className="text-slate-700 dark:text-slate-200 font-bold">Continuar con Google</span>
                        </button>

                        {/* Footer Link */}
                        <p className="text-center text-slate-600 dark:text-slate-400 font-medium pt-4">
