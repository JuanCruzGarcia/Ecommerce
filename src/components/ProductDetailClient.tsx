        ...
        <div className="text-slate-900 font-display">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 max-w-7xl mx-auto">
                ...
                <div className="flex flex-col space-y-6">
                    <div>
                        ...
                        <div className="flex items-center gap-3 mb-2">
                            <div className="flex items-center gap-2 px-3 py-1 bg-green-500/10 border border-green-500/20 rounded-full">
                                ...
                                <span className="text-[10px] font-black text-green-600 uppercase tracking-widest">{isOutOfStock ? 'Sin Stock' : 'Stock disponible'}</span>
                            </div>
                    ...
                    <div className="bg-slate-50 p-5 rounded-2xl border border-primary/5">
                                    ...
                                    {variantOption.values.map((val: string) => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`px-4 py-2 rounded-xl text-xs font-black transition-all duration-200 border-2 ${isSelected ? 'border-primary bg-primary/5 text-primary shadow-md scale-105' : 'border-slate-100 bg-white text-slate-500 hover:border-primary/40 hover:text-primary'}`}
                                            >
                                                {val}
                                            </button>
                                        );
