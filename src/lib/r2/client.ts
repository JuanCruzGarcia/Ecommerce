...
export const R2_BUCKET_NAME = process.env.R2_BUCKET_NAME || 'distriphone-products';
export const R2_PUBLIC_URL = process.env.R2_PUBLIC_URL || ''; // Tu dominio público del bucket
